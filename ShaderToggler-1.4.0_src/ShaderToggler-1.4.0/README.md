...
```ini
Name=DOF
Notice=Negatively affects some cutscenes.
```

A small warning indicator appears next to the group name and displays the notice when hovered.
