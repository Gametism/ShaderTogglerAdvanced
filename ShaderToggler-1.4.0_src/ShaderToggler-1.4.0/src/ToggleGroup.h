...
namespace ShaderToggler
{
	...
	public:
		...
		void addAssignedTechniqueName(const std::string& name);
		void setAssignedTechniqueNameAt(size_t index, const std::string& name);
		void removeAssignedTechniqueNameAt(size_t index);
		void clearAssignedTechniqueNames();
		bool hasAssignedTechniqueNames() const;
		size_t getAssignedTechniqueNameCount() const;
		const std::string& getAssignedTechniqueNameAt(size_t index) const;
		const std::vector<std::string>& getAssignedTechniqueNames() const;

		AssignedTechniqueMode getAssignedTechniqueMode() const;
		void setAssignedTechniqueMode(AssignedTechniqueMode mode);
		static const char* assignedTechniqueModeToString(AssignedTechniqueMode mode);
		static int assignedTechniqueModeToInt(AssignedTechniqueMode mode);
		static AssignedTechniqueMode assignedTechniqueModeFromInt(int value);
	...
	private:
		...
		std::vector<std::string> m_assignedTechniqueNames;
		AssignedTechniqueMode m_assignedTechniqueMode;
