...
namespace ShaderToggler
{
	...
	public:
		...
		void setToggleKey(uint8_t newKeyValue, bool = false, bool altRequired = false, bool ctrlRequired = false);
		...
		void loadState CDataFile& iniFile, int index, bool usingCustomFormat);
